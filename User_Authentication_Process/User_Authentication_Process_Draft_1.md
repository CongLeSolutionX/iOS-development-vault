...
### 1. The Login Process with Security Considerations
...
```mermaid
---
title: "The Login Process with Security Considerations"
author: "Cong Le"
version: "1.0"
license(s): "MIT, CC BY 4.0"
copyright: "Copyright (c) 2025 Cong Le. All Rights Reserved."
...
sequenceDiagram
    ...
    LoginPage ->> RateLimiter: Check Login Attempts (Username/IP)
    ...
    rect rgb(20, 50, 150)
        alt Exceeds Rate Limit
            ...
            rect rgb(220, 50, 150)
                LoginPage ->> AuthenticationService: Authenticate (Username, Password)
                ...
                rect rgb(120, 50, 150)
                    alt Successful Authentication
                        ...
                        rect rgb(20, 50, 150)
                            ...
                            LoginPage ->> RateLimiter: Increment Failed Attempts (Username/IP)
...
sequenceDiagram
    ...
    rect rgb(20, 50, 150)
        alt Successful Password Authentication
            ...
            SecondFactorService ->> User: Send Verification Code (e.g., OTP)
...
sequenceDiagram
    ...
    LoginPage ->> PasswordResetService: Initiate Password Reset (Email)
    ...
    rect rgb(20, 50, 150)
        alt Email Found
            rect rgb(100, 50, 150)
                ...
                PasswordResetService ->> EmailService: Send Password Reset Email (with Link)
                EmailService ->> User: Email Sent
                User ->> EmailClient: Click Reset Link
                EmailClient ->> PasswordResetService: Validate Reset Token (via Link)
                rect rgb(120, 50, 150)
                    alt Valid Token and Not Expired
                        ...
                        LoginPage ->> PasswordResetService: Update Password (User ID, New Password)
            ...
            rect rgb(150, 50, 150)
                PasswordResetService -->> LoginPage: Display Error Message (Generic)
