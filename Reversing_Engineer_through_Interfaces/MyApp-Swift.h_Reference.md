...
The content below is an generated interface of an app called `MyApp`, using Xcode:
...
@interface VideoCapture (SWIFT_EXTENSION(MyApp)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)viewDidLoad;
- (void)developerModeToggled:(UISwitch * _Nonnull)sender;
- (void)telephotoCameraToggled:(UISwitch * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)modelChanged:(UISegmentedControl * _Nonnull)sender;
